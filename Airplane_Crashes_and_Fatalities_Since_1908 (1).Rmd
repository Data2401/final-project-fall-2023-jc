...
This dataset is over the airplane crashes and fatalities that have occured throughout the years since 1908. Many of these are unknown while others, are historical events. With this data, we will be able to gain a better understanding on how the type of aircraft is correlated to the number of crashes and fatalities.
